...
# It includes:
# (1) calculating the annual runoff ratio of an individual stream from yearly precipitation and yearly runoff; and
# (2) comparing the stream runoff ratio to the average runoff ratio of the watershed that the stream lies in;
# (3) stating whether the stream has a higher/lower runoff ratio than the watershed. 
# 
# Calculating the runoff ratio is important for flood control and possible flood zone hazard
# delineation. Our program’s target audience are hydrologists, water
# resource and flood risk specialists. It will also be accessible to the general public as it may be
# especially useful to those residing close to the river
#
# 
# Program structure:
# 
