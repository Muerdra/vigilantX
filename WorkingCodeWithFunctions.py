import csv
# calculates total runoff for 2008 by calling and performing calculations on the Discharge2008.csv file
# which contains daily dischage for 2008 of the Mississipi River at Ferguson Falls. ****Done by Craig****** 
def SumRunoff2008():
...
# calculates total runoff for 2018 by calling and performing calculations on the Discharge2018.csv file
# which contains daily dischage for 2018 of the Mississipi River at Ferguson Falls. ****Done by Craig****** 
def SumRunoff2018():
...
# calculates total precipitation for 2008 by calling and performing calculations on the Precipitation2008.csv file
# which contains daily precipitation for 2008 by the Mississipi River at Ferguson Falls.****Done by Craig******    
...
# calculates total precipitation for 2018 by calling and performing calculations on the Precipitation2018.csv file
# which contains daily precipitation for 2018 by the Mississipi River at Ferguson Falls.****Done by Craig******    
...
# calculates the runoff ratio of the Mississipi River at Ferguson Falls using total runoff and total precipitation.*****Done by Mike***** 
def RiverRunoffRatio(SRR, SPR):
    RnoffRatioRiv = float(SRR) / float(SPR)
    return RnoffRatioRiv

# calculates the runoff ratio of the entire Mississipi Valley Watershed by using average runoff and precipitation
# constants from the years 1971 to 2000, from the source:
# https://www.mrsourcewater.ca/images/Documents/ConceptualWaterBudget/MainReport/M-RConceptualWaterBudget_PrelimDraft.pdf *****Done by Mike****
def MVWRunoffRatio():
    AvgRnoff = 367.0
    AvgPrecip = 898.0
